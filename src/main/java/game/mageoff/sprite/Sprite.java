...
import game.mageoff.movement.Position;
...
public abstract class Sprite {
  ...
  public Sprite(Group sceneGroup, double[] offset, double scale, boolean startEnabled) {
    enabled = false;
    iv = new ImageView();
    this.sceneGroup = sceneGroup;
  ...
  public void drawUpdate() {
    ...
    double x = pos.getX() - img.getWidth() / 2 + offset[0] * scale;
    double y = pos.getY() - img.getHeight() / 2 + offset[1] * scale;
